...
private extension CVCalendarViewAnimator {
    ...
    func deselectionWithFadeOutEffect() -> ((DayView, ((Bool) -> ())) -> ()) {
        return {
            dayView, completion in
            UIView.animateWithDuration(0.6, delay: 0, usingSpringWithDamping: 0.6, initialSpringVelocity: 0, options: /*nil*/UIViewAnimationOptions.BeginFromCurrentState, animations: {
