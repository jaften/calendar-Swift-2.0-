...
public final class CVCalendarManager {
    ...
    public func monthDateRange(date: NSDate) -> (countOfWeeks: NSInteger, monthStartDate: NSDate, monthEndDate: NSDate) {
        ...
        let components = calendar.components([YearUnit , MonthUnit , WeekUnit], fromDate: date)
    ...
    public func weekdayForDate(date: NSDate) -> Int {
        ...
        let _/*weekday*/ = calendar.ordinalityOfUnit(units, inUnit: WeekUnit, forDate: date)
    ...
    public static func componentsForDate(date: NSDate) -> NSDateComponents {
        ...
        let components = NSCalendar.currentCalendar().components([YearUnit , MonthUnit , WeekUnit , DayUnit], fromDate: date)
